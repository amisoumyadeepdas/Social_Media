            ...
            <div className={styles.sidebarWrapper}>
                <ul className={styles.sidebarList}>
                    <li className={styles.sidebarListItem}>
                        ...
                        <span className={styles.sidebarListItemText}><a href="https://twitter.com/settings/account" style={{ textDecoration: "none" }}>Twitter</a></span>
                    </li>
                    <li className={styles.sidebarListItem}>
                        <Chat className={styles.sidebarIcon} />
                        <span className={styles.sidebarListItemText}><a href="https://www.facebook.com/settings/?tab=profile_and_tagging" style={{ textDecoration: "none" }}>Facebook</a></span>
                    </li>
                    <li className={styles.sidebarListItem}>
                    ...
                    <li className={styles.sidebarListItem}>
                        <School className={styles.sidebarIcon} />
                        <span className={styles.sidebarListItemText}><a href="/content" style={{ textDecoration: "none" }}>Content</a></span>
                    </li>
                </ul>
